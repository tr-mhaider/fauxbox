...
func apiRoutes() *http.ServeMux {
	...
	r.HandleFunc("PUT "+config.Webroot+"api/v1/messages", middleWareFunc(apiv1.RequireAuth(apiv1.SetReadStatus)))
	r.HandleFunc("DELETE "+config.Webroot+"api/v1/messages", middleWareFunc(apiv1.RequireAuth(apiv1.DeleteMessages)))
	r.HandleFunc("GET "+config.Webroot+"api/v1/search", middleWareFunc(apiv1.RequireAuth(apiv1.Search)))
	r.HandleFunc("DELETE "+config.Webroot+"api/v1/search", middleWareFunc(apiv1.RequireAuth(apiv1.DeleteSearch)))
	...
	r.HandleFunc("DELETE "+config.Webroot+"api/v1/tags/{tag}", middleWareFunc(apiv1.RequireAuth(apiv1.DeleteTag)))
	r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}/part/{partID}", middleWareFunc(apiv1.RequireAuth(apiv1.DownloadAttachment)))
	r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}/part/{partID}/thumb", middleWareFunc(apiv1.RequireAuth(apiv1.Thumbnail)))
	r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}/headers", middleWareFunc(apiv1.RequireAuth(apiv1.GetHeaders)))
	r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}/raw", middleWareFunc(apiv1.RequireAuth(apiv1.DownloadRaw)))
	r.HandleFunc("POST "+config.Webroot+"api/v1/message/{id}/release", middleWareFunc(apiv1.RequireAuth(apiv1.ReleaseMessage)))
	r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}/html-check", middleWareFunc(apiv1.RequireAuth(apiv1.HTMLCheck)))
	r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}/link-check", middleWareFunc(apiv1.RequireAuth(apiv1.LinkCheck)))
	if config.EnableSpamAssassin != "" {
		r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}/sa-check", middleWareFunc(apiv1.RequireAuth(apiv1.SpamAssassinCheck)))
	}
	r.HandleFunc("GET "+config.Webroot+"api/v1/message/{id}", middleWareFunc(apiv1.RequireAuth(apiv1.GetMessage)))
